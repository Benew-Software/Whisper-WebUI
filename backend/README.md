...
2. Edit [`nginx.conf`](https://github.com/Benew-Software/Whisper-WebUI/blob/master/backend/nginx/nginx.conf) for your domain name.
https://github.com/Benew-Software/Whisper-WebUI/blob/895cafe400944396ad8be5b1cc793b54fecc8bbe/backend/nginx/nginx.conf#L12
...
4. Open a terminal and go to the location of [`nginx.conf`](https://github.com/Benew-Software/Whisper-WebUI/blob/master/backend/nginx/nginx.conf), then start the nginx server, so that you can manage nginx-related logs there.
```shell
cd backend/nginx
...
## Configuration
You can set some server configurations in [config.yaml](https://github.com/Benew-Software/Whisper-WebUI/blob/master/backend/configs/config.yaml). 
...
https://github.com/Benew-Software/Whisper-WebUI/blob/1dd708ec3844dbf0c1f77de9ef5764e883dd4c78/backend/docker-compose.yaml#L12-L15
3. Build the image
```
