...
And you can also run the project with command line arguments if you like to, see [wiki](https://github.com/Benew-Software/Whisper-WebUI/wiki/Command-Line-Arguments) for a guide to arguments.
...
Read [wiki](https://github.com/Benew-Software/Whisper-WebUI/wiki/Command-Line-Arguments) for more info about CLI args.
